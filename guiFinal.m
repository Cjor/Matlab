...
% Last Modified by GUIDE v2.5 21-Feb-2017 17:44:23
...
for grupo=1:1:variable%  hasta N 
    ...
    error = 0;
     ...
     for vector1Vertical = 1 : 1 : ancho1
         for vector2Vertical = 1 : 1 : ancho2
            ...
            step = step+1
            waitbar(step/steps )
            %ahora evaluo el vector 1 punto a punto con el vector 2 teniendo en cuenta que juntos tengan el mismo tama?o
            if largo1 == largo2
